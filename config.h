...
static const char col_blackbg[]     = "#1d1f21";
static const char col_bluefg[]      = "#50BEDF";
static const char col_yellowfg[]    = "#FCEF0A";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_bluefg, col_blackbg, col_bluefg },
	[SchemeSel]  = { col_black, col_bluefg, col_yellowfg },
};
